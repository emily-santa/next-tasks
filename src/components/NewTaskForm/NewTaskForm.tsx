...
const NewTaskForm = () => {
    ...
    const SubmitButton = () => {
        ...
        return (
            <button type="submit" className="mt-8 py-2 w-full rounded-md text-white bg-rose-400 hover:bg-rose-300 text-sm font-semibold shadow-sm disabled:bg-gray-400" disabled={pending}>新規追加</button>
        ...
        <div className="mt-10 mx-auto w-full max-w-sm">
            <form action={formAction}>
                ...
                <div className="mt-6">
                    ...
                    <input type="date" id="duedate" name="duedate" min="2025-01-01" max="2900-12-31" required className="block mt-2 py-1.5 px-2 w-full rounded-md border-0 shadow-sm ring-1 ring-inset ring-gray-300" />
                </div>
                <SubmitButton />
